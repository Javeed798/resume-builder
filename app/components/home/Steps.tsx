const STEPS = [
  ...
  },
  {
    ...
    text: "and apply with confidence",
  },
];

export const Steps = () => {
  return (
    <section className="mx-auto mt-8 rounded-2xl bg-sky-200 bg-dot px-8 pb-12 pt-10 lg:mt-2">
              ...
              <dt className="text-lg font-bold">
                <div className="bg-primary absolute left-0 top-1 flex h-10 w-10 select-none items-center justify-center rounded-full p-[3.5px] opacity-80">
                  <div className="flex h-full w-full items-center justify-center rounded-full bg-white">
                    <div className="text-primary -mt-0.5 text2xl">
                      {idx + 1}
                    </div>
                  </div>
                </div>
